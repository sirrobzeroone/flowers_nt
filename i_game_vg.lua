...
minetest.register_on_joinplayer(function(player)
	...
	if flowers_nt.rollback then
		inv_replace = {["flowers_nt:brown_mushroom_5"] = "flowers:mushroom_brown_spores", 
					   ["flowers_nt:red_mushroom_5"]   = "flowers:mushroom_red_spores"}
	else
		inv_replace = {["flowers:mushroom_brown_spores"] = "flowers_nt:brown_mushroom_5", 
					   ["flowers:mushroom_red_spores"]   = "flowers_nt:red_mushroom_5"}
	end						 
...
if not flowers_nt.rollback then
	...
	minetest.register_lbm({
		  name = "flowers_nt:convert_vg_spores",
		  ...
		  action = function(pos, node)
						if minetest.get_node(pos).name == "flowers:mushroom_brown_spores" then				
							minetest.set_node(pos, {name="flowers_nt:brown_mushroom_5"})				
						else				
